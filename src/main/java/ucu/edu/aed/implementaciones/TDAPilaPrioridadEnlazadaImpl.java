...
public class TDAPilaPrioridadEnlazadaImpl<T> extends TDAListaEnlazadaImpl<T> implements TDAPila<T> {

    private final Comparator<T> comparador;

    public TDAPilaPrioridadEnlazadaImpl(Comparator<T> comparador) {
        if (comparador == null) {
