...
public class TDAColaPrioridadEnlazadaImpl<T> extends TDAListaEnlazadaImpl<T> implements TDACola<T> {

    private final Comparator<T> comparador;

    public TDAColaPrioridadEnlazadaImpl(Comparator<T> comparador) {
        if (comparador == null) {
