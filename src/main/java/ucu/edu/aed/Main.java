...
import ucu.edu.aed.comisiones.FormulaComision;
import ucu.edu.aed.comisiones.ParserFormula;
import ucu.edu.aed.comisiones.ServicioComisiones;
...
import ucu.edu.aed.productos.FabricaPaquetes;
...
public class Main {
        public static void main(String[] args) {
                ...
                System.out.println("\nAltas de producto auditadas: "
                                + sucursalAuditoria.cantidadInteraccionesPorTipo(TipoInteraccion.ALTA_PRODUCTO));

                sucursalAuditoria.darBajaComponentePaquete(clienteAuditoria, paqueteParaAuditar, 3);
                System.out.println("Bajas de producto auditadas: "
                                + sucursalAuditoria.cantidadInteraccionesPorTipo(TipoInteraccion.BAJA_PRODUCTO));
                // ==========================
                ...
                sucursalFormula.registrarCambioFormula(
                                "Cambio de fórmula de comisión a: " + formulaNueva.mostrarFormula());
