...
/**
 * Casos de prueba para {@link TDAColaPrioridadConArregloImpl}.
 */
public class TDAColaPrioridadConArregloImplTest extends TestCase {

    public void testConstructorConComparadorNuloLanzaExcepcion() {
        try {
            new TDAColaPrioridadConArregloImpl<Integer>(null);
    ...
    public void testColaNuevaEsVacia() {
        TDAColaPrioridadConArregloImpl<Integer> cola = new TDAColaPrioridadConArregloImpl<Integer>(Comparator.<Integer>naturalOrder());
    ...
    public void testContieneYIndiceDe() {
        TDAColaPrioridadConArregloImpl<String> cola = new TDAColaPrioridadConArregloImpl<String>(Comparator.<String>naturalOrder());
        cola.poneEnCola("b");
        cola.poneEnCola("a");
