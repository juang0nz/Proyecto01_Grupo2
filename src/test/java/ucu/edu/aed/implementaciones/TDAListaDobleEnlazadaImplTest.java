...
public class TDAListaDobleEnlazadaImplTest extends TestCase {

    public void testListaNuevaEsVacia() {
        TDALista<Integer> lista = new TDAListaDobleEnlazadaImpl<Integer>();
    ...
    public void testAgregarEnIndice() {
        TDALista<String> lista = new TDAListaDobleEnlazadaImpl<String>();
        lista.agregar("a");
        lista.agregar("c");
        lista.agregar(1, "b");
